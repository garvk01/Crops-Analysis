...
//     // ✅ WEATHER + INSIGHTS (FIXED)
//     let weatherSummary = {};
//     let insights = [];

//     try {
//       const weatherData = await fetchWeatherForCrop(cropData);
//       console.log("🌦 Weather Data:", weatherData);

//       weatherSummary = weatherData.summary;

//       insights = generateInsights(result, cropData, weatherSummary);
//     } catch (err) {
//       console.error("❌ Weather/Insights Error:", err.message);
//       insights = generateInsights(result, cropData);
//     }
...
//     const timeSeries = demo.data.map(d => ({
